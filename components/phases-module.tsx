...
export function PhasesModule() {
  ...
  const phases = [
    {
      id: 1,
      title: "Fase Única: Desarrollo Completo",
      duration: "6 horas",
      subphases: [
        {
          title: "Ideación",
        ...
        },
        {
          ...
          duration: "3 horas",
          description: "Codificación intensiva, implementación de funcionalidades principales e integración de APIs.",
        },
        {
          title: "Pulido y Pruebas",
          duration: "2 horas",
          description: "Refinamiento del código, corrección de bugs, optimización de performance y mejora de UX.",
        },
        {
          title: "Presentación",
          duration: "30 minutos",
          description: "Preparación de la demo, pitch ante los jueces, demostración en vivo y Q&A.",
        },
      ],
    },
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 p-6 md:p-8 bg-primary/10 border-2 border-primary/30 pixel-corners text-center">
          <p className="text-sm md:text-base text-muted-foreground">
            <span className="font-bold text-primary">Total: 6 horas</span> de desarrollo intensivo sprint, desde la idea
